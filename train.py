...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
    ...
    """
    if not tf.compat.v1.gfile.FastGFile(image_dir):
    ...
    print('--------------------------------------------------')
    print('\n')
    print('Started: Loading Training Directory')
    print('\n')
    ...
    print('Completed: Loading Training Directory')
    print('\n')
    return result
...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
    ...
    image_path = get_image_path(image_lists, label_name, index,
                              image_dir, category)
    if not tf.compat.v1.gfile.FastGFile(image_path):
...
def cache_bottlenecks(sess, image_lists, image_dir, bottleneck_dir,
    ...
    print('\n')
    print('--------------------------------------------------')
    print('Started: Bottleneck Creation')
    print('\n')
    ...
    print('\n')
    print('Completed: Bottleneck Creation')
    print('\n')
...
def main(_):
    print('\n Loading Real-Time Sign Language Gesture Recognition Codes\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='logs/trained_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='logs/trained_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='logs/training_summaries',
